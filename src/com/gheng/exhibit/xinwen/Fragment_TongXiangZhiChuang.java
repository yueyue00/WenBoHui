...
public class Fragment_TongXiangZhiChuang extends Fragment implements OnRefreshListener {
	...
	Fragment_TongXiangZhiChuang(ProgressDialog pro) {
		this.pro = pro;
	}
	private int ka= 0;
	/**
...
//						Toast.LENGTH_SHORT).show();
	...
	public Fragment_TongXiangZhiChuang() {
	...
	class rvonscrolllistener extends RecyclerView.OnScrollListener {
		...
		public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
			...
			if (llm.findLastCompletelyVisibleItemPosition() == list_news.get(0).liebiao
				...
				if (isloading == 0 && pagecount != 1 && cat_id != null&&pagecount!=pagenum) {
