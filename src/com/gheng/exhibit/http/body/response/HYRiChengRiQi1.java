...
public class HYRiChengRiQi1 {
	...
	private int iscolor;
	private int iskz;
	public List<HYRiChengGuest> rlist = new ArrayList<HYRiChengGuest>();
	...
	public List<HYRiChengGuest> getRlist() {
		return rlist;
	}

	public void setRlist(List<HYRiChengGuest> rlist) {
		this.rlist = rlist;
	}
	...
	public String toString() {
		return "HYRiChengRiQi [date=" + date + ", week=" + week
				...
				+ ", iscolor=" + iscolor + ", iskz=" + iskz + ", rlist="
				+ rlist + "]";
	}
