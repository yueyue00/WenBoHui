...
public class AdapterForHuiYiRiChengHuiC extends
		RecyclerView.Adapter<ViewHolder> {
	private List<HYRiChengRiQi> list;
	private LayoutInflater li;
	private Context context;

	public AdapterForHuiYiRiChengHuiC(ArrayList<HYRiChengRiQi> list,
			Context context) {
		this.list = list;
	...
	public void onBindViewHolder(ViewHolder vh, int position) {
		...
		// mvh.imagebutton_dingwei.setVisibility(View.VISIBLE);
		// 主讲人：textview
		...
		mvh.iv_angle.setBackgroundResource(R.drawable.wuzhen_mineroute_date1);
	...
	class MyViewHolder extends RecyclerView.ViewHolder {
		...
		public MyViewHolder(View itemView) {
			...
			// imagebutton_dingwei = (ImageView) itemView
			// .findViewById(R.id.imagebutton_dingwei);
		}
	}
