...
public class HuiYiStickAdapterForRiqi extends BaseAdapter implements
StickyListHeadersAdapter, SectionIndexer{
	...
	public HuiYiStickAdapterForRiqi(Context context, List<DaHuiDate> datas) {
...
//			long cur = 1470798373009L;
//			String currentTime = Constant.getCurrentTime(cur);
//			System.out.println("======currentTime=====string==>"+currentTime);
			
			containerLayout.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
//            Toast.makeText(context, "您点击的是日程位置为："+bean.meettingtitle, Toast.LENGTH_LONG).show();	
