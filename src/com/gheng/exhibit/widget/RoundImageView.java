...
public class RoundImageView extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		if(drawable instanceof AsyncDrawable){
			try {
				Field declaredField = drawable.getClass().getDeclaredField("baseDrawable");
				declaredField.setAccessible(true);
				BitmapDrawable nDrawable = (BitmapDrawable) declaredField.get(drawable);
				b = nDrawable.getBitmap();
			} catch (Exception e) {
				e.printStackTrace();
			}
		}else{
