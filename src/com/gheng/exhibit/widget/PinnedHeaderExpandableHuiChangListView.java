...
public class PinnedHeaderExpandableHuiChangListView extends ExpandableListView
		implements OnScrollListener, OnGroupClickListener {
	public PinnedHeaderExpandableHuiChangListView(Context context,
	 ...
	 */
	public interface HeaderHuiChangAdapter {
	...
	private HeaderHuiChangAdapter mAdapter;
	...
	public void setHeaderView(View view) {
		...
		int height = getContext().getResources().getDimensionPixelSize(
				R.dimen.schedule_list_title_height);
		AbsListView.LayoutParams lp = new AbsListView.LayoutParams(
				ViewGroup.LayoutParams.MATCH_PARENT, height);// ViewGroup.LayoutParams.WRAP_CONTENT
	...
	public void setAdapter(ExpandableListAdapter adapter) {
		...
		mAdapter = (HeaderHuiChangAdapter) adapter;
	}
...
//			parent.collapseGroup(groupPosition);
	...
	public void configureHeaderView(int groupPosition, int childPosition) {
		...
		switch (state) {
		case HeaderHuiChangAdapter.PINNED_HEADER_GONE: {
			mHeaderViewVisible = false;
			break;
		}

		case HeaderHuiChangAdapter.PINNED_HEADER_VISIBLE: {
		...
		case HeaderHuiChangAdapter.PINNED_HEADER_PUSHED_UP: {
