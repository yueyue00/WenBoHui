...
public class zAsyncTaskForHuiChang extends AsyncTask<Integer, Integer, Integer> {
	...
	public zAsyncTaskForHuiChang(Message m, Context context, String userid) {
		this.m = m;
	...
	protected Integer doInBackground(Integer... params) {
		try {
			...
			URL url = new URL(Constant.DOMAIN
					+ "/taskSign.do?method=commTaskBysj&userId=" + userid);
			...
			if (is != null) {
				...
				System.out.println("zAsyncTaskForHuiChang:json" + json);
				...
				if (bpojo.code.equals("200")) {// 请求成功 300是没数据
					...
					QianDaoHuiChangInfo qinChangInfo = (QianDaoHuiChangInfo) Constant.gson
							.fromJson(object, QianDaoHuiChangInfo.class);
					m.obj = qinChangInfo;
					return 0;
				} else {
					m.obj = bpojo.message;
