...
/**
 * 自定义TextView 解决 英文单词在TextView上自动换行排版问题
 * 重要说明:如果文本不是预加载的，那么在settext之前，先要把isfirsttimeondraw改成true
 */
public class NsTextView extends TextView {
	...
	public boolean isfirsttimeondraw=true;
	...
	protected void onDraw(Canvas canvas) {
		...
		if(isfirsttimeondraw){
			setHeight((int) ((lineCount + 2) * (int) textSize));
			isfirsttimeondraw=false;
		}
	}
}
