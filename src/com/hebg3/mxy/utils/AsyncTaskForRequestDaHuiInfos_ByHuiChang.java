...
public class AsyncTaskForRequestDaHuiInfos_ByHuiChang extends AsyncTask<Integer, Integer, Integer>{
	...
	public Editor e;
	public AsyncTaskForRequestDaHuiInfos_ByHuiChang(Message m,Context context) {
		this.m = m;
	...
	protected Integer doInBackground(Integer... params) {
		...
		try {
			URL url=new URL(Constant.DOMAIN+"/meetings.do?method=getMeetInfoByMeetType&lg="+SharedData.getInt("i18n", Language.ZH));
			...
			if(is!=null){
			    ...
			    if(bpojo.code.equals("200")){//请求成功
					...
					m.obj = infos;
					e.putString("huiyirichengbyhuichang", Constant.encode(Constant.key,bpojo.info.toString()));
					e.apply();
					return 2;
